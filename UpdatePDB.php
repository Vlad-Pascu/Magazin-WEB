                ...
                if(isset($_POST['id']))
                    {
                        ...
                        $prod_chip=$_POST['producator_chip'];
                        ...
                        mysqli_query($conn,"UPDATE placa_de_baza SET forma='$forma',soclu='$soclu',producator_chip='$prod_chip',model_chip='$model_chip',
                        interfata_grafica='$interfata',tip_memorie='$memorie' WHERE specificatii_id='$specificatii'");
                        $nume=$_POST['nume'];
                        $poza=$nume.".jpg";
