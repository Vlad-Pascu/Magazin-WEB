    ...
    <div id="main">
        ...
        <div id="main_content">
             <?php
                    ...
                    $nr=5;
                    $result=mysqli_query($conn,"SELECT * FROM produs,sursa WHERE produs.componenta_id=5 AND produs.specificatii_id=sursa.specificatii_id ORDER BY id");

                    echo "<table>";
                    While($row1=mysqli_fetch_assoc($result))
                    {
                        echo "<tr>";
                            echo "<td>". "<img src=\"Styles\images\Sursa\\".$row1['poza']."\" alt=".$row1['nume'].">";
                            echo "<hr>";
                            echo "</td>";
                            echo "<td>".$row1['id']. ".Sursa ". $row1['producator']." ". $row1['nume'];
                            echo "<ul>";
                                echo "<li>". "Putere: ". $row1['putere']."W</li>";
                                echo "<li>". "Eficienta: ". $row1['eficienta']."</li>";
                                echo "<li>". "Certificare: ". $row1['certificare']."</li>";
                            echo "</ul>";
                            echo "</td>";
                            echo "<td>";
