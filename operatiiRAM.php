...
<body>
    ...
    <div id="main">
        ...
        <div id="main_content">
            <p>
                <form action="AdaugaRAM.php" method=post>
                    ...
                    <label for="tip">Tip memorie:</label>
                    ...
                    <label for="latenta">Latenta:</label>
                    <input type="text" name="latenta"><br>
                    <input type="submit" value="Adauga"><br>
                    <br>
                </form>
                <form action="StergeRAM.php" method=post>
                ...
                <form action="UpdateRAM.php" method=post>
