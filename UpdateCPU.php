                ...
                if(isset($_POST['id']))
                    {
                        ...
                        mysqli_query($conn,"UPDATE procesor SET socket='$socket',serie='$serie',nucleu='$nucleu',frecventa='$frecventa',
                        tehnologie='$tehnologie' WHERE specificatii_id='$specificatii'");
                        $nume=$_POST['nume'];
                        $poza=$nume.".jpg";
