    ...
    <div id="main">
        ...
        <div id="main_content">
             <?php
                    ...
                    $nr=4;
                    $result=mysqli_query($conn,"SELECT * FROM produs,ram WHERE componenta_id='$nr' AND produs.specificatii_id=ram.specificatii_id ORDER BY id");
                    echo "<table>";
                    While($row1=mysqli_fetch_assoc($result))
                    {
                        echo "<tr>";
                            echo "<td>". "<img src=\"Styles\images\RAM\\".$row1['poza']."\" alt=".$row1['nume'].">";
                            echo "<hr>";
                            echo "</td>";
                            echo "<td>".$row1['id']. ".RAM ". $row1['producator']." ". $row1['nume'];
                            echo "<ul>";
                                echo "<li>". "Tip memorie: ". $row1['tip']."</li>";
                                echo "<li>". "Capacitate: ". $row1['capacitate']." GB</li>";
                                echo "<li>". "Frecventa: ". $row1['frecventa']." Mhz</li>";
                                echo "<li>". "Latenta: ". $row1['latenta']." CAL</li>";
                            echo "</ul>";
                            echo "</td>";
                            echo "<td>";
