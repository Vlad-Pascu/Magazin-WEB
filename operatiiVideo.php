...
<body>
    ...
    <div id="main">
        ...
        <div id="main_content">
            <p>
                <form action="AdaugaVideo.php" method=post>
                    ...
                    <label for="interfata">Interfata:</label>
                    <input type="text" name="interfata"><br>
                    <label for="tip_memorie">Tip memorie:</label>
                    <input type="text" name="tip_memorie"><br>
                    <label for="dim_memorie">Dimensiune memorie:</label>
                    <input type="text" name="dim_memorie"><br>
                    <input type="submit" value="Adauga"><br>
                </form>
                <form action="StergeVideo.php" method=post>
                ...
                <form action="UpdateVideo.php" method=post>
                    ...
                    <input type="text" name="tip_memorie"><br>
                    <label for="dim_memorie">Dimensiune memorie:</label>
                    <input type="number" name="dim_memorie"><br>
