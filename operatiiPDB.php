...
<body>
    ...
    <div id="main">
        ...
        <div id="main_content">
            <p>
                <form action="AdaugaPDB.php" method=post>
                    ...
                    <label for="soclu_procesor">Soclu procesor:</label>
                    <input type="text" name="soclu_procesor"><br>
                    <label for="producator_chip">Producator chip:</label>
                    <input type="text" name="producator_chip"><br>
                    <label for="model_chip">Model chip:</label>
                    <input type="text" name="model_chip"><br>
                    <label for="interfata_grafica">Interfata:</label>
                    <input type="text" name="interfata_grafica"><br>
                    <label for="tip_memorie">Memorie:</label>
                    <input type="text" name="tip_memorie"><br>
                    <input type="submit" value="Adauga"><br>
                </form>
                <form action="StergePDB.php" method=post>
                ...
                <form action="UpdatePDB.php" method=post>
