                ...
                if(isset($_POST['id']))
                    {
                        ...
                        mysqli_query($conn,"UPDATE placa_video SET serie='$serie',interfata='$interfata',tip_memorie='$tip_memorie',dim_memorie='$dim_memorie'
                        WHERE specificatii_id='$specificatii'");
                        $nume=$_POST['nume'];
                        $poza=$nume.".jpg";
