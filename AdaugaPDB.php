        ...
        <div id="main_content">
            <p>
                <?php
                    ...
                    if(isset($_POST['forma']) && isset($_POST['soclu_procesor']) && isset($_POST['producator_chip']) && isset($_POST['model_chip'])
                    && isset($_POST['interfata_grafica']) && isset($_POST['tip_memorie']))
                        {
                            $forma=$_POST['forma'];
                            $soclu=$_POST['soclu_procesor'];
                            $producator_chip=$_POST['producator_chip'];
                            $model_chip=$_POST['model_chip'];
                            $interfata=$_POST['interfata_grafica'];
                            $memorie=$_POST['tip_memorie'];
                            $query="INSERT INTO placa_de_baza (forma,soclu_procesor,producator_chip,model_chip,interfata_grafica,
                            tip_memorie) VALUES ('$forma','$soclu','$producator_chip','$model_chip','$interfata','$memorie')";
                            ...
                            VALUES ('$nume','$poza','$producator','$pret','10','2','$nr')");
                        }
                    mysqli_close($conn);
                ?>
            </p>
